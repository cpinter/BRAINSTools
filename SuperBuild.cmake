...
# -DCTEST_TEST_TIMEOUT:STRING=${CTEST_TEST_TIMEOUT}
# -DDEBUGGING_PRINT_IMAGES:BOOL=${DEBUGGING_PRINT_IMAGES}
  -DEXTERNAL_PROJECT_BUILD_TYPE:STRING=${EXTERNAL_PROJECT_BUILD_TYPE}
  -DFORCE_EXTERNAL_BUILDS:BOOL=${FORCE_EXTERNAL_BUILDS}
  #-DGENERATECLP_EXE:FILEPATH=${GENERATECLP_EXE}
